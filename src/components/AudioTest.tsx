...
export default function AudioTest() {
  ...
  const handlePlay = (fileName: string) => {
    ...
    setTimeout(() => {
      ...
      setTestResults(prev => ({ ...prev, [fileName]: 'error' }));
    }, 3000);
  };
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-6">
      <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Phonics Audio Test</h1>
        ...
        <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-200">
          <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3">Important Information</h3>
