...
export default function LevelCard({ level, classCount, onSelect }: LevelCardProps) {
  return (
    <div
      className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer border-2 border-transparent hover:border-gray-100"
      onClick={onSelect}
    >
      <div
        className="h-3"
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-1">{level.name}</h3>
        ...
        <p className="text-gray-700 leading-relaxed mb-6 min-h-[80px]">
          {level.overview}
        </p>
